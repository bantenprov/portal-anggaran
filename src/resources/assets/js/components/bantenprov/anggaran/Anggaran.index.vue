<template>
  <div class="card">
    <div class="card-header">
      <i class="fa fa-table" aria-hidden="true"></i> Anggaran
...
export default {
  ...
  methods: {
    createRow() {
      window.location = '#/admin/anggaran/create';
    },
    viewRow(rowData) {
      window.location = '#/admin/anggaran/' + rowData.id;
    },
    editRow(rowData) {
      window.location = '#/admin/anggaran/' + rowData.id + '/edit';
    },
    deleteRow(rowData) {
      let app = this;

      if (confirm('Do you really want to delete it?')) {
        axios.delete('/api/anggaran/' + rowData.id)
